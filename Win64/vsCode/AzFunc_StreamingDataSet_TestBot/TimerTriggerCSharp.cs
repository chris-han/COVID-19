...
namespace SensorSim
{
    public static class TimerTriggerCSharp
    {
        ...
        public static async void Run([TimerTrigger("*/5 * * * * *")]TimerInfo myTimer, ILogger log)
        {
            ...
            string powerBI_API = "https://api.powerbi.cn/beta/4bdd9bf4-3bc1-411d-bf50-2c33f64cf161/datasets/d9e80cb2-d462-4935-89d3-ec1e5387c146/rows?key=T0GzKItOlDUKpQ8pTvnB5K1rNiqsmFB%2B9UVNZvMjNFkqaLfW%2Fwfkj7UqvVCgv7sJzNO%2FkWGZI%2FtyOgXtgLOJPA%3D%3D";
